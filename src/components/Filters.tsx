        ...
        <div className="flex items-center gap-4 w-full lg:w-auto">
          <div className="flex items-center gap-1 w-full md:w-auto">
            <select
              value={selectedSort}
              onChange={(e) =>
                onSortChange(e.target.value as "taxonomy" | "size" | "rarity")
              }
            ...
            <button
              ...
              title={
                sortOrder === "asc" ? "Ordem Ascendente" : "Ordem Descendente"
              }
            ...
            <div className="flex flex-col md:flex-row gap-4">
              <label className="relative inline-flex items-start cursor-pointer group">
                ...
                <span className="ml-3 text-sm font-medium text-gray-700 group-hover:text-forest-green transition-colors mt-0.5">
                  Apenas Espécies Ameaçadas
                </span>
              </label>

              <label
                className={`relative inline-flex items-start group ${!selectedMonth ? "opacity-40 cursor-not-allowed" : "cursor-pointer"}`}
              >
                <input
                  type="checkbox"
                ...
                <span className="ml-3 text-sm font-medium text-gray-700 group-hover:text-forest-green transition-colors mt-0.5">
                  ...
                  {!selectedMonth && (
                    <span className="text-[10px] block font-normal text-gray-400 normal-case">
