...
const SpeciesModal = ({
  ...
  const similarSpeciesList = species.details?.similarSpecies
    ?.map((sim) => {
  ...
  return (
    ...
    >
      ...
      <div
        ref={modalRef}
        className="bg-white rounded-2xl shadow-2xl w-full max-w-[94vw] max-h-[94vh] overflow-y-auto animate-in fade-in zoom-in-95 duration-200"
      >
          ...
          <div className="w-full md:w-1/2 p-6 md:p-8 flex flex-col relative">
            ...
            <div className="flex flex-wrap gap-4 mb-4">
              ...
              >
                {sizePos ? (
                  ...
                  <svg
                    className="w-8 h-8 text-green-700/50"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                  ...
                  <>
                    {displayed.map((family, idx) => {
                      ...
                      if (
                        ...
                        floraOnLink = species.ecology.hostPlantSpecies[
                          family
                        ][0].replace(" spp.", "");
                      }
                        ...
                        >
                          {plantPos ? (
                            <div
                              ...
                              style={{
                                backgroundImage:
                                  'url("imgs/plant_family_sprite.webp")',
                    ...
                    {hidden.length > 0 && (
                      ...
                      >
                        ...
                        <span className="text-[10px] font-bold uppercase tracking-tight mt-1 opacity-60">
                          Famílias
                        </span>
                      </div>
                    )}
            ...
            {(species.details?.identificationTips ||
              ...
              <div className="mb-6">
                {species.details?.identificationTips &&
                similarSpeciesList &&
                similarSpeciesList.length > 0 ? (
                  <div className="flex space-x-2 border-b border-gray-200 mb-4">
                    <button
                      className={`pb-2 px-1 text-sm font-semibold border-b-2 transition-colors flex items-center gap-2 ${
                        activeTab === "tips"
                    ...
                    <button
                      className={`pb-2 px-1 text-sm font-semibold border-b-2 transition-colors flex items-center gap-2 ml-4 ${
                        activeTab === "similar"
                          ? "border-forest-green text-forest-green"
                          : "border-transparent text-gray-400 hover:text-gray-600 hover:border-gray-300"
                      }`}
