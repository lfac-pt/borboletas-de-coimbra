  ...
  const guidelines = [
    ...
    },
    {
      ...
      items: [
        ...
        <span key="platform">
          Registe os dados na plataforma{" "}
          <a
            href="https://butterfly-monitoring.net/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-blue-600 hover:text-blue-800 underline underline-offset-2 hover:decoration-2 transition-all"
          >
          ...
          <div className="relative z-20 bg-white/90 backdrop-blur-md border-b border-gray-100/50 flex justify-between p-6 pr-16 md:px-10 md:pr-24 md:py-8 rounded-t-2xl md:rounded-t-[2rem]">
            <div className="space-y-1 md:space-y-2">
              ...
              <p className="text-sm md:text-base text-gray-500 font-light max-w-2xl mt-2 leading-relaxed">
                A metodologia padrão do eBMS (European Butterfly Monitoring
                Scheme) baseia-se em transectos. Siga estas diretrizes simples
                para que as suas contagens sejam válidas do ponto de vista
                científico.
              </p>
            </div>
            <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
              {guidelines.map((guide, index) => (
                ...
                >
                  {/* Content Container */}
                  <div
                    className={`relative flex flex-1 p-6 sm:p-8 ${
                      guide.title === "Área de Contagem" ||
                      guide.title === "Identificação taxonómica" ||
                      guide.title === "Registo de Dados"
                        ? "flex-col lg:flex-row gap-8 lg:items-center"
                        : "flex-col"
                    }`}
                  >
                    ...
                    <div className="flex flex-col flex-1">
                      <div className="mb-4 flex items-center gap-4">
                        <div
                          className={`p-3 rounded-2xl ${guide.lightBg} ${guide.textColor} shrink-0`}
                        >
                          {guide.icon}
                        </div>
            ...
            <div className="mt-12 flex flex-col items-center gap-4 max-w-2xl mx-auto w-full">
              <div className="w-full flex items-center gap-3 px-6 py-4 bg-forest-green/5 text-forest-green rounded-2xl text-sm font-medium border border-forest-green/10">
                ...
                <div className="text-left">
                  <p className="font-bold text-gray-900 mb-0.5 uppercase tracking-wide text-xs">
                    Atenção ao detalhe
                  </p>
                  <p className="text-gray-700">
                    Se um indivíduo voar de trás para a sua frente atravessando
                    a caixa, ou for detetado a repousar dentro da mesma, deve
                    ser contado.
                  </p>
                </div>
              </div>
              ...
              <div className="w-full flex items-center gap-3 px-6 py-4 bg-red-500/5 text-red-600 rounded-2xl text-sm font-medium border border-red-500/10">
                ...
                <div className="text-left w-full">
                  <p className="font-bold text-gray-900 mb-1.5 uppercase tracking-wide text-xs">
                    Segurança
                  </p>
                  <ul className="text-gray-700 list-disc list-inside space-y-1">
                    <li>
                      Atenção às condições meteorológicas: roupa adequada e
                      proteja sempre a pele e a cabeça com um chapéu.
                    </li>
                    <li>Tenha consigo o seu telemóvel.</li>
                    <li>
                      Tendo em conta a área, tenha atenção às carraças e outros
                      animais que possam transmitir doenças.
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="w-full flex items-center gap-3 px-6 py-4 bg-purple-500/5 text-purple-600 rounded-2xl text-sm font-medium border border-purple-500/10">
                ...
                <div className="text-left w-full">
                  ...
                  <p className="text-gray-700">
                    A informação aqui apresentada teve por base o{" "}
                    <a
                      href="https://www.tagis.pt/uploads/4/7/9/5/47950987/manual_censos_de_borboletas_final.pdf"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="text-purple-600 hover:text-purple-800 underline underline-offset-2 hover:decoration-2 transition-all font-semibold"
                    >
                      Manual de Monitorização de Borboletas
                    </a>{" "}
                    coordenado pelo Tagis. Consulte-o para conhecer em detalhe o
                    método de contagem em transectos.
                  </p>
                </div>
              </div>
            </div>
...
const TransectBoxDiagram = () => (
  <div className="w-full flex justify-center mt-4 lg:mt-0 xl:scale-110">
    <svg
      viewBox="0 0 500 420"
      className="w-full h-auto max-h-[280px] sm:max-h-[340px] drop-shadow-sm font-sans"
    >
      <defs>
      ...
      {/* Topo */}
      <polygon
        points="250,190 410,110 250,30 90,110"
        fill="url(#boxTop)"
        stroke="#059669"
        strokeWidth="1"
        strokeLinejoin="round"
      ...
      {/* Esquerda */}
      <polygon
        points="250,330 90,250 90,110 250,190"
        fill="url(#boxLeft)"
        stroke="#059669"
        strokeWidth="1"
        strokeLinejoin="round"
      ...
      {/* Direita */}
      <polygon
        points="250,330 410,250 410,110 250,190"
        fill="url(#boxRight)"
        stroke="#059669"
        strokeWidth="1"
        strokeLinejoin="round"
      ...
      <g transform="translate(250, 325)">
        ...
        <rect
          ...
          height="6"
          fill="#f8fafc"
          transform="rotate(10 7 -22)"
        />
        {/* Tronco de costas */}
        <path
          d="M-7,-26 L7,-26 L6,-6 L-6,-6 Z"
          fill="#1e293b"
          stroke="#1e293b"
          strokeWidth="2"
          strokeLinejoin="round"
        ...
        <path
          d="M-7,-24 L-9,-12 L-5,-6 M7,-24 L9,-12 L5,-6"
          fill="none"
          stroke="#334155"
          strokeWidth="3.5"
          strokeLinecap="round"
      ...
      <line
        ...
        markerEnd="url(#arrow)"
      />
      <text x="35" y="185" fill="#334155" fontSize="14" fontWeight="bold">
        5m
      </text>
      <text x="35" y="200" fill="#64748b" fontSize="11">
        altura
      </text>
      ...
      <rect
        ...
        rx="4"
      />
      <text x="278" y="254" fill="#0f172a" fontSize="12" fontWeight="bold">
        5m frente
      </text>
...
const TaxonomyTreeDiagram = () => (
  <div className="w-full flex justify-center mt-4 lg:mt-0 xl:scale-100">
    <svg
      viewBox="0 0 430 300"
      className="w-full h-auto max-h-[300px] sm:max-h-[340px] drop-shadow-sm font-sans"
    >
      <defs>
        <marker
          id="arrow-down"
      ...
      <text x="5" y="25" fill="#a855f7" fontSize="12" fontWeight="bold">
        1. Família
      </text>
      <text x="5" y="105" fill="#a855f7" fontSize="12" fontWeight="bold">
        2. Género
      </text>
      <text x="5" y="185" fill="#a855f7" fontSize="12" fontWeight="bold">
        3. Espécie
      </text>
      ...
      <g transform="translate(75, 0)">
        ...
        <path
          d="M200,110 L200,130 L110,130 L110,160"
          stroke="#d8b4fe"
          strokeWidth="2"
          fill="none"
          markerEnd="url(#arrow-down)"
        ...
        />
        <path
          d="M200,110 L200,130 L290,130 L290,160"
          stroke="#d8b4fe"
          strokeWidth="2"
          fill="none"
          markerEnd="url(#arrow-down)"
        ...
        <path
          d="M110,190 L110,210 L50,210 L50,240"
          stroke="#e9d5ff"
          strokeWidth="2"
          fill="none"
          markerEnd="url(#arrow-down)"
        ...
        />
        <path
          d="M110,190 L110,210 L170,210 L170,240"
          stroke="#e9d5ff"
          strokeWidth="2"
          fill="none"
          markerEnd="url(#arrow-down)"
        ...
        >
          Pieris
          <tspan fill="#f3e8ff" fontStyle="normal" fontSize="11">
            {" "}
            sp.
          </tspan>
        </text>
        ...
        <image
          ...
          width="90"
          height="64"
          href="imgs/sp/Pieridae/Pieris rapae.webp"
          preserveAspectRatio="xMidYMid slice"
          clipPath="url(#rounded-photo)"
        />
        <image
          x="120"
          y="230"
          width="90"
          height="64"
          href="imgs/sp/Pieridae/Pieris brassicae.webp"
          preserveAspectRatio="xMidYMid slice"
          clipPath="url(#rounded-photo)"
        />
        <image
          ...
          width="90"
          height="64"
          href="imgs/sp/Pieridae/Gonepteryx cleopatra.webp"
          preserveAspectRatio="xMidYMid slice"
          clipPath="url(#rounded-photo)"
        />
  ...
  <div className="w-full flex justify-center mt-4 lg:mt-0 xl:scale-100 font-sans">
    <div className="relative w-full max-w-[280px] bg-[#fdfbf7] rounded-sm shadow-md border border-gray-200/60 p-5 rotate-1">
      ...
      <div className="text-[13px] text-gray-600 font-medium mb-4 grid grid-cols-2 gap-y-1 gap-x-2 border-b border-gray-200/60 pb-3">
        <span>
          Nuvens: <span className="text-gray-900 font-semibold">5</span>
        </span>
        <span>
          Temp: <span className="text-gray-900 font-semibold">14°C</span>
        </span>
        <span>
          Vento vel.: <span className="text-gray-900 font-semibold">Lig.</span>
        </span>
        <span>
          Vento dir.: <span className="text-gray-900 font-semibold">N</span>
        </span>
      ...
      <div className="space-y-3 font-mono text-sm leading-snug">
        <div>
          <h4 className="text-xs font-bold text-gray-400 uppercase tracking-widest mb-1 font-sans">
            Secção 1
          </h4>
        ...
        <div>
          ...
          <div className="text-gray-400 italic flex items-center gap-2">0</div>
        </div>
