...
const FamiliesInfographicModal = ({
  onClose,
}: FamiliesInfographicModalProps) => {
  ...
  const families = [
    {
      ...
      description:
        'Borboletas de corpo muito robusto e cabeça larga. Têm um voo rápido e "saltitante".',
      features: [
    ...
    },
    {
      ...
      description:
        "Entre as nossas maiores borboletas. Muitas têm prolongamentos nas asas posteriores idênticos a caudas.",
      features: [
    ...
    },
    {
      ...
      description:
        'Vulgarmente conhecidas como as "brancas" e as "amarelas", algumas são muito comuns em zonas rurais/agrícolas.',
      features: [
    ...
    },
    {
      ...
      description:
        "Borboletas de pequenas dimensões. Os machos têm frequentemente faces dorsais azuladas maravilhosas, ardentes ou cobre.",
      features: [
          ...
          <div className="relative z-20 bg-white/90 backdrop-blur-md border-b border-gray-100/50 flex justify-between p-6 pr-16 md:px-10 md:pr-24 md:py-8 rounded-t-2xl md:rounded-t-[2rem]">
            <div className="space-y-1 md:space-y-2">
              ...
              <p className="text-sm md:text-base text-gray-500 font-light max-w-2xl mt-2 leading-relaxed">
                Descubra como distinguir as 5 famílias de borboletas diurnas que
                podemos encontrar na região. Cada uma com características
                morfológicas e comportamentos únicos.
              </p>
            </div>
            <button
              onClick={onClose}
          ...
          <div className="p-6 md:p-10 bg-slate-50/50">
              ...
              {families.map((family, index) => (
                ...
                >
                  ...
                  <div className="relative overflow-hidden h-56 sm:h-64 bg-gray-100">
                    ...
                    />
                    <div
                      className={`absolute bottom-0 left-0 right-0 h-1.5 ${family.color}`}
                    ></div>
                  </div>
                  ...
                  <div className="relative flex flex-col flex-1 p-6 sm:p-8">
                    ...
                    <div
                      className={`absolute -right-4 -top-4 w-24 h-24 rounded-full blur-3xl opacity-20 group-hover:opacity-40 transition-opacity pointer-events-none ${family.color}`}
                    ></div>
                    ...
                    <div className="mb-6">
                      ...
                      <p
                        className={`text-sm sm:text-base tracking-wide font-bold uppercase mb-4 relative z-10 ${family.textColor}`}
                      >
                        {family.commonName}
                      </p>
                    ...
                    {/* Features List */}
                    <div
                      className={`flex-1 ${family.lightBg} p-5 rounded-xl border ${family.border} w-full relative z-10`}
                    >
                      <h4
                        className={`text-xs uppercase tracking-wider font-bold mb-3 opacity-80 ${family.textColor}`}
                      >
                        Como Identificar
                      </h4>
                      <ul className="space-y-3">
                        {family.features.map((feature, i) => (
                          ...
                          >
                            <span
                              className={`mr-2.5 mt-0.5 flex-shrink-0 w-4 h-4 rounded-full flex items-center justify-center text-white ${family.color}`}
                            >
                              <svg
            ...
            <div className="mt-12 text-center">
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-forest-green/10 text-forest-green rounded-full text-sm font-medium border border-forest-green/20">
                ...
                Lembre-se: a prática leva à perfeição. Ao longo do tempo, as
                silhuetas gerais de cada família tornam-se inconfundíveis!
              </div>
            </div>
          </div>
        </div>
